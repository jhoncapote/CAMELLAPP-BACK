            ...
            <div class="col-11">
                ...
                <div class="row">
                    <div class="col-11">
                        ...
                        <h4 class="d-flex align-items-baseline">experiencia De Trabajo : {{ experiencia.experienciaDeTrabajo }}</h4>
                    </div>
                    <hr>
                </div>
                <hr><br>
                <div>
                    <div class="row  d-flex justify-content-center  ">
                        ...
                        <b-button v-on:click="eliminarExperiencia()" class="col-3" variant="danger" >Eliminar Experiencia</b-button>
                    </div>
                </div>
            </div>
        </div>
